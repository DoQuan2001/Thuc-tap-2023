...
![hình 2](/.vscode/OSI/images/mohinhosilagichucnangcuacactanggiaothuctrongmohinhosi.png)

Mô hình OSI tuân theo các nguyên tắc phân tầng như sau:

1. Mô hình gồm N = 7 tầng. OSI là hệ thống mở, phải có khả năng kết nối với các hệ thống khác nhau, tương thích với các chuẩn OSI.
...
3. Thiết lập kênh logic nhằm mục đích thực hiện việc trao đổi thông tin giữa các thực thể.1.
...
![hình 2](/.vscode/OSI/images/chucnanglop.png)
